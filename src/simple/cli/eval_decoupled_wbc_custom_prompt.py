...
def _run_eval_worker(
    ...
    for eps_idx in episode_indices:
        ...
        #sample instruction from list of possible instructions
        possible_instructions = [
            "Pick up the blue tote from the shelf with your left hand and place it on the right table.",
            "Pick up the blue tote from the shelf with your left hand and place it on the left table.",
            "Pick up the blue tote from the shelf with your right hand and place it on the right table.",
            "Pick up the blue tote from the shelf with your right hand and place it on the left table.",
            "Pick up the blue tote from the shelf with your left hand and place it on the right table.", 
            "Pick up the blue tote from the shelf with your right hand",
            "Pick up the blue tote from the shelf with your left hand",
            "place the tote on the right table.",
            "place the tote on the left table.",
            # "Pick up the blue tote from the shelf with your right hand and place it on the table at your left.",
            # "Pick up the blue tote from the shelf with your right hand and place it on the table at your right.",
            # "Pick up the blue tote from the shelf with your left hand and place it on the table at your right.",
            # "Pick up the blue tote from the shelf with your left hand and place it on the table at your left.",
        ]
        instruction = choice(possible_instructions) 

        print(
            f"Robot stabilized after {sim_cnt} simulation steps. Engaging Policy Now!"
        )
        print(f"Starting task_id {task_id}. Instruction : {instruction}")
        ...
        _append_eval_stats_line(eval_dir, f"{task_id} {instruction}: {is_success} \n")
        report(
            "episode_end",
            episode=task_id,
            step=frame_idx,
